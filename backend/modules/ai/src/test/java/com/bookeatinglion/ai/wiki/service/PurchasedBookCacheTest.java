...
class PurchasedBookCacheTest {

    private static final String MEMBER_ID = "test-cognito-sub-1";
    private static final String KEY = "ai:purchased:" + MEMBER_ID;

    private StringRedisTemplate redis;
    private SetOperations<String, String> setOperations;
    private PurchasedBookCache cache;
    ...
    void setUp() {
        ...
        PurchasedBookRepository purchasedBookRepository = mock(PurchasedBookRepository.class);
        when(redis.opsForSet()).thenReturn(setOperations);

        cache = new PurchasedBookCache(redis, purchasedBookRepository);
    }
